          ...
          <div className="section-wrapper full-width full-height p-relative">
            ...
            <div className="section-container full-height p-relative">
              ...
              >
                <div className="text-block">
                  <p className="text-block-css full-width">
                    (Tức Ngày 22 Tháng 11 Năm Ất Tỵ)
                    <br />
                  </p>
                </div>
              </div>
          ...
          <div className="section-wrapper full-width full-height p-relative">
            ...
            <div className="section-container full-height p-relative">
              ...
              <div id="w-m1kk35d9" className="com-html-box p-absolute">
                <div className="frame-html-box full-width full-height">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2027.1329318188425!2d106.96597062442162!3d10.863774193184677!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174e109728a35bb%3A0xc57efc20dfd6e908!2zTmjDoCBIw6BuZyBUaeG7h2MgQ8aw4bubaSBNYWkgTGFuIDI!5e1!3m2!1svi!2s!4v1763310340006!5m2!1svi!2s"
                    width="600"
                    height="450"
                    style={{ border: 0 }}
...
export default WeddingInviationGreen;
